...
SRC = 0-binary_tree_node.c binary_tree_print.c 1-binary_tree_insert_left.c 2-binary_tree_insert_right.c \
	  ...
	  7-binary_tree_inorder.c 8-binary_tree_postorder.c 9-binary_tree_height.c 10-binary_tree_depth.c \
	  11-binary_tree_size.c 12-binary_tree_leaves.c 13-binary_tree_nodes.c 14-binary_tree_balance.c main.c
OBJ = $(SRC:.c=.o)
NAME = a
RM = rm
